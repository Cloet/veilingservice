...
namespace veilingservice.Migrations
{
    ...
    [Migration("20200809102501_Users")]
    partial class Users
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("veilingservice.Model.User", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("veilingservice.Model.LotImage", b =>
                {
                    b.HasOne("veilingservice.Model.Lot", null)
                        .WithMany("Images")
                        .HasForeignKey("LotID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("veilingservice.Model.User", b =>
                {
                    b.HasOne("veilingservice.Model.ApiKey", "Key")
                        .WithMany()
                        .HasForeignKey("KeyID");
                });
